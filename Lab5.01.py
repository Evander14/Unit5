...
user_choice = input("Hello! What phrase would you like explained? ")
if user_choice in phrase_dictionary:
    print(phrase_dictionary[user_choice])
else:
    print("Sorry, that phrase isnt defined.")
